/* Bounded input gate only. Waypoint storage, deathpoints and permissions belong to /waypoints. */
function createJasprWaypointKeybind(api) {
  "use strict";
  ...
  return {
    ...
    sent:function () { sent++; },
    status:function () { return {defaultKey:"M", cooldownMs:cooldownMs, pending:!!pending, accepted:accepted, sent:sent}; }
  };
}
if (typeof module !== "undefined") module.exports = {createJasprWaypointKeybind:createJasprWaypointKeybind};
